...
# uh maybe this too, but i never used it when pushing from localhost back in Jan: 🟢🟢>> aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 535002851677.dkr.ecr.us-east-1.amazonaws.com
#
